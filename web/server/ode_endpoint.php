...
<h3 id="the_word"><?= $word ?></h3>
<textarea id="new_ode_example" name="new_ode_example" placeholder="word in the wild" style="width:100%; height:0.5in;"></textarea>
<textarea id="new_ode_comment" name="new_ode_comment" placeholder="comment" style="width:100%; height:0.5in;"></textarea>
<a href="javascript:void(0)" id="ode_save" class="button-b">Save</a>

<!--
"Here's to the Halcyon, forever may she rest"
Old 97s, Here's to the Halcyon, Blame it on Gravity
 -->
